...
public class Employee {
	...
	public static void binarySearchName(Employee[]arr,String key) {
		...
		public static void main(String[] args) {
	     ...
	     employee[0]=new Employee(1,"shriya");
	     employee[1]=new Employee(2,"shraddha");
	     employee[2]=new Employee(3,"deependra");
	     employee[3]=new Employee(4,"shreyash");
	     
	     binarySearch(employee,3);
	     binarySearchName(employee,"shriya");
	   }
